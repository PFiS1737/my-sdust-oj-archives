...
struct Point {
  ...
  Point(const Point &p) : x(p.x), y(p.y) {
    cout << "A Point (" << x << ", " << y << ") is copied! Now, we have " << ++numOfPoints
         << " points." << endl;
  }

  ~Point() {
    cout << "A Point (" << x << ", " << y << ") is erased! Now, we have " << --numOfPoints
         << " points." << endl;
  }
...
struct Circle {
  ...
  Circle(int x = 0, int y = 0, int r = 1) : c(x, y), r(r) {
    cout << "A circle at (" << c.x << ", " << c.y << ") and radius " << r
         << " is created! Now, we have " << ++numOfCircles << " circles." << endl;
  }
  ...
  ~Circle() {
    cout << "A circle at (" << c.x << ", " << c.y << ") and radius " << r
         << " is erased! Now, we have " << --numOfCircles << " circles." << endl;
  }

  bool pointInCircle(const Point &p) const {
